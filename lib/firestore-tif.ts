...
const booksCollection = collection(db, 'books-tif');
...
export async function addBook(
  ...
  try {
    ...
    if (hasReview) {
      const reviewsRef = collection(db, 'books-tif', bookRef.id, 'reviews');
...
export async function getBookById(bookId: string): Promise<Book | null> {
  try {
    const docRef = doc(db, 'books-tif', bookId);
...
export async function updateBook(
  ...
  try {
    const bookRef = doc(db, 'books-tif', bookId);
...
export async function deleteBook(bookId: string): Promise<void> {
  try {
    const reviewsRef = collection(db, 'books-tif', bookId, 'reviews');
...
export async function updateReview(
  ...
  try {
    const reviewRef = doc(db, 'books-tif', bookId, 'reviews', reviewId);
